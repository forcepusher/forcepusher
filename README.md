...
12GB GPU VRAM + 24GB RAM:  
[**FacerollGPT**]([https://huggingface.co/unsloth/Qwen3.6-27B-GGUF/tree/main](https://huggingface.co/unsloth/Qwen3.5-9B-GGUF/tree/main)) 64k - unsloth/qwen3.5-9b@q6_k_xl (Q8_0 KV Cache, temperature 0.6, top k 20, min p 0)  
