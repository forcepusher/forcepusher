...
[**Local Robot**](https://huggingface.co/unsloth/Qwen3.6-27B-GGUF/tree/main) 32k - unsloth/qwen3.6-27b@q3_k_xl (slow but works, compute 12 layers on CPU, temperature 0.3 top k 40)  
