...
unsloth/gemma-4-31b-it@iq4_nl (for 24GB GPU, very reliable and heavy, have to use Q8_0 KV Cache, set temperature to 0.5)  
unsloth/gemma-4-31b-it@iq3_xxs (for 16GB GPU + 48GB RAM, starter option, have to use Q8_0 KV Cache, set temperature to 0.5)  
