...
[**Local Robot**](https://huggingface.co/unsloth/Qwen3.6-27B-GGUF/tree/main) 40k - unsloth/qwen3.6-27b@q3_k_xl (use Q8 KV Cache, compute 8 layers on CPU, temp 0.3, top k 40)  
...
Try not to use Q8_0 KV Cache. It kills the tool calls because it introduces typos, and lobotomizes reasoning of the model.  
