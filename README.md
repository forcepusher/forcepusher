...
Current Transformers LLM architecture is basically T9 text prediction from old Nokia phones. Repeatedly tap on your phone's text predictions - this is the current state of "AI".  
LLM is not even a neural network, it's an autocomplete dictionary.  
