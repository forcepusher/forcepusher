...
On 16GB VRAM card you will have 100k context window while computing 4 layers on CPU, but it's a crackhead model. It's basically for testing before buying hardware for a fat model.  
