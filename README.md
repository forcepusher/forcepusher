...
But don't let LLMs think for you or build an architecture - it's all random pointless garbage.  
...
Starter option, pretty dumb model yet gets the job done: 12GB GPU VRAM + 32GB RAM  
...
### Other instruments:  
- [PortableAgent](https://github.com/forcepusher/PortableAgent) - Rule prompt for local LLMs like Gemma and Qwen. Read less slop and get much better results. 
