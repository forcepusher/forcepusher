...
AI is about the volume, not quality.  
...
### Other instruments:  
- [smol-caveman](https://github.com/forcepusher/smol-caveman) - Caveman Ultra designed for local LLMs. Faster parsing, less tokens, dumb-model-friendly.  
