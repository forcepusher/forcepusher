...
Put `Think with attention to details, stop the thought at 10 paragraphs.` in the rule or system prompt to avoid schizo thinking loops, or just use my [portable caveman](https://github.com/forcepusher/smol-caveman) prompt.  
