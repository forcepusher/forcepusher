...
On 16GB VRAM card you will have 40k context window while computing 8 layers on CPU, and it's still a Crackhead model. It's basically for testing before buying hardware for a fat model.  
