...
[**Gemma 4**](https://huggingface.co/unsloth/gemma-4-31B-it-GGUF/tree/main) 56k - unsloth/gemma-4-31b-it@iq4_xs (temp 0.6, top k 64, min p 0.05)  
...
I use very low temperatures to prevent tool use typos/screwups, since I mostly use LLM for refactoring.  
