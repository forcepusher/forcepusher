...
Current Transformers LLM architecture is essentially T9 text prediction from old phones, and models are just dictionaries.  
Repeatedly tap on your phone's text predictions - this is the current state of AI. We need hybrid text diffusion models.  
Now that you have proper expectations, you're ready to start building. Autocomplete is a good tool anyway.  
