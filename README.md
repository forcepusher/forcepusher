...
**Wasserman** 32k - unsloth/gemma-4-31b-it@iq4_nl (for 24GB GPU, very heavy and reliable, use temperature 0.5)  
...
Across all Gemma 4 models use top k sampling 64, min p sampling 0.1.  
