...
Put `Think with attention to details, STRICTLY STOP the thought at 10 paragraphs.` rule or use my [portable caveman](https://github.com/forcepusher/smol-caveman) prompt.  
