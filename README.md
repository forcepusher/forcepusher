...
Some people compare it to a parrot with gigantic brain. It's still just a parrot though.  
...
Our videocards can not only run games, but write somewhat useful code. That's pretty cool right?  
