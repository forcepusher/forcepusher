...
unsloth/gemma-4-31b-it@iq4_nl (for 24GB GPU, very reliable and heavy, have to use temp 0.3 and Q8_0 KV Cache)  
unsloth/gemma-4-31b-it@iq3_xxs (for 16GB GPU + 32GB RAM, starter option, same temp 0.3 and Q8_0 KV Cache)  
On 16GB VRAM card you will only have 24k context window while offloading 2 layers to CPU. This is barely enough to get any meaningful work done, but anyone can test the thing before buying hardware.  
