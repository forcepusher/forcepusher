...
[**Qwen 3.6 27B MTP**](https://huggingface.co/unsloth/Qwen3.6-27B-MTP-GGUF/tree/main) up to ~100k - unsloth/qwen3.6-27b-mtp@q6_k_xl (temp 0.6, top k 20)  
[**Gemma 4 31B**](https://huggingface.co/unsloth/gemma-4-31B-it-GGUF/tree/main) up to ~100k - unsloth/gemma-4-31b-it@q5_k_xl (temp 0.3, top k 40)  
...
[**Qwen 3.6 27B MTP**](https://huggingface.co/unsloth/Qwen3.6-27B-MTP-GGUF/tree/main) 40k - unsloth/qwen3.6-27b-mtp@q4_k_xl (temp 0.6, top k 20)  
...
- [com.bananaparty.websocketclient](https://github.com/forcepusher/com.bananaparty.websocketclient) - Basic fully cross-platform websocket client.  
