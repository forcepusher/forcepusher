...
qwen/qwen3.6-27b@q4_k_m (for 24GB GPU, probably best all-rounder, huge context window)  
...
Mixture Of Experts Models (A4B, A3B) are useless too unless you're running them partially on CPU and using at least Q6_K.  
