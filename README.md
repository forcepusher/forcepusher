...
[**Gemma 4**](https://huggingface.co/unsloth/gemma-4-31B-it-qat-GGUF/tree/main) 40k - unsloth/gemma-4-31b-it-qat@q4_k_xl (temp 0.6, top k 40)  
...
[**Gemma 4 12B**](https://huggingface.co/unsloth/gemma-4-12B-it-qat-GGUF/tree/main) 80k - unsloth/gemma-4-12b-it-qat@q4_k_xl (it's pretty damn stupud, temp 0.1, top k 40)  
...
If you can get anything done on small model, buy RTX 3090 or a multi-GPU setup for 32GB+ VRAM.  
